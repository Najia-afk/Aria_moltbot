...
EXCLUDE_PATHS = {
    ...
    "plans/sprint",
    # Verification script that checks for OpenClaw references (meta-check)
    "scripts/verify_pyproject.py",
    # Legacy redirect routes kept for backward compatibility (301 → /chat/)
    "src/web/app.py",
    # Old workspace path reference (historical artifact)
    "aria_mind/aria_mind/skills",
}
