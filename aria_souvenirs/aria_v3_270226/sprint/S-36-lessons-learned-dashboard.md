...
curl -s "http://localhost:${ARIA_API_PORT:-8000}/api/lessons/dashboard" | python3 -m json.tool | head -20
...
curl -s "http://localhost:${ARIA_API_PORT:-8000}/api/lessons/dashboard" | python3 -c "
import json, sys
